module.exports = {
  ...
  var comfyArr = [
    ...
    msg.author + ' being under a comfy blanket always makes things better <:morning:375083204937383938>',
    'Don\'t forget to take a breather and relax ' + msg.author + '. Maybe we could play a game!',
    'We appreciate you ' + msg.author + '! <:ghosthug:375897079979048961>',
    'Hey, you\'re doing a really great job ' + msg.author + '!',
    'You can do it <:happee:375083422315708416>',
    'You\'ve got friends here if you need someone to talk to ' + msg.author + ' (but take it to the vent channel <:fingerguns:375083362383167499>)',
    'It\'s good to know your limits - I know you\'re doing the best you can ' + msg.author + ':sparkling_heart:',
    msg.author + ' why be moody when you can shake yo booty <:hotboi:375083569313218561>',
